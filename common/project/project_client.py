...
class ProjectObject:
    ...
    async def update(
        ...
        async with httpx.AsyncClient(timeout=self.project_client.timeout) as client:
...
class ProjectClient:
    def __init__(self, project_url, redis_url, enable_cache=True, is_async=True, timeout: int = 30):
